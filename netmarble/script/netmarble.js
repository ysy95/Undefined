...
$(document).ready(function(){
  ...
  const around_txt = $('.conv-tab_txt');
    ...
    switch(around_img_no){
      ...
      case 5 : around_txt.find('strong').text('넷마블 스토어');around_txt.find('p').html("<p>넷마블 대표 캐릭터 '넷마블 프렌즈'와 넷마블의 다양한 인기게임 상품들을<br>직접 보고 구매할 수 있습니다.</p>") ;
      break;

      case 6 : around_txt.find('strong').text('공원');around_txt.find('p').html('<p>도심 생태계를 지키기 위한 대규모 녹지로<br>누구나 이용 가능한 휴식, 문화 공간입니다.</p>') ;
      break;
